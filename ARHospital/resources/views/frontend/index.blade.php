...
<section class="w-full bg-gray-950 py-20">
    <div class="px-10 lg:px-20 flex justify-center items-center w-full lg:h-[60rem] py-10 lg:flex-row flex-col">
    ...
    <div class="w-full flex lg:flex-row-reverse flex-col-reverse my-20 lg:justify-center items-center">
        ...
        <div class="">
            <img src="{{ asset('images/img5.png')}}" alt="" class="h-[30rem] lg:w-[30rem] w-96 lg:m-0 mx-4 mt-2">
        </div>
